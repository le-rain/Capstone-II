...
files = [%"01 Testing Videos/LK-B-01-122-70.mp4", 1, 1;
         %"01 Testing Videos/LK-B-02-116-64.mp4", 1, 1;
         %"01 Testing Videos/LK-B-03-90-60.mp4", 1, 1;
         %"01 Testing Videos/LK-B-04-90-60.mp4", 1, 1;     
         %"01 Testing Videos/LK-B-05-100-70.mp4", 1, 1;
         %"01 Testing Videos/LK-B-06-105-75.mp4", 1, 1;
         %"01 Testing Videos/LK-B-07-90-70.mp4", 1, 1;
         ...
         "01 Testing Videos/LK-B-11-104-68.mp4", 1, 1;
         ...
         %"01 Testing Videos/KC-B-12-104-78.mp4", 1, 1;
         %"01 Testing Videos/KC-B-13-102-58.mp4", 300, 1, 1;
         %"01 Testing Videos/KC-B-14-100-66.mp4", 1, 1;
         %"01 Testing Videos/kc-h-01-126-66.mp4", 120, 0, 0;
         %"01 Testing Videos/kc-h-02-108-72.mp4", 1, 1;
...
for i = 1:n_files
    ...
    [sectionI, sectionS2, allS2, ~, ~] = audioPulse(audio, plotWholeAudioOption, plotAudioSectionOption);
    I{i} = sectionI;
    S2{i} = sectionS2;
end